...
import * as parser from "./diceroll.js";
import {
...
export class DiceRoller {
	...
	public alwaysAverage: boolean; 
	public alwaysCrit: boolean;
	/**
	 ...
	 */
	constructor({ randFunction, maxRolls = 1000, alwaysAverage = false, alwaysCrit: alwaysCrit = false }: { randFunction?: () => number; maxRolls?: number; alwaysAverage?: boolean; alwaysCrit?: boolean; } = {}) {
		if (randFunction) {
	...
	private getRoll = (inputDie: number) => {
